...
updated: 2022-10-24T16:00:00+02:00
image:
  alt: "Logo Next.js"
  caption: "Logo Next.js"
  src: "./next-js-logo.png"
categories: ["web development"]
tags: ["next.js", "csr", "ssr", "ssg", "isr", "jamstack"]
type: "post"
---
...
Jeżeli chcesz zobaczyć statyczne generatory treści w szerszym kontekście, wcześniej napisałem post o całej [architekturze Jamstack](/blog/jamstack-what-why-how/).
...
```jsx #Client-Side Rendering w Next.js
...
```jsx #Server-Side Rendering w Next.js
...
```jsx #Static Site Generation w Next.js
...
```jsx #Incremental Static Regeneration w Next.js
export async function getStaticProps(context) {
  return {
    props: {},
    revalidate: 10,
