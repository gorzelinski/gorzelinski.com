...
```jsx #Client-Side Rendering in Next.js
...
```jsx #Server-Side Rendering in Next.js
...
```jsx #Static Site Generation in Next.js
...
```jsx #Incremental Static Regeneration in Next.js
export async function getStaticProps(context) {
  return {
    props: {},
    revalidate: 10,
