...
Paralelizacja pomaga w testach wielu przeglądarek. Playwright wprowadza koncept "projektów", gdze każdy z nich może służyć jako odrębna [przeglądarka](https://playwright.dev/docs/browsers), włączając Safari.
