---
title: Intro to web components—what are custom elements?
...
In this post we learned about custom elements—one of three pillars of web components. We can use them to teach the browser new HTML tags with their behavior, lifecycle, and state. And all of that without using a framework. In the next post, we'll explore [Shadow DOM](/blog/every-dom-element-casts-a-shadow/)—how to encapsulate styles and markup so they don't leak. Stay tuned! In the meantime, check the resources below.
