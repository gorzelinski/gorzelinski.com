...
W [ostatnim wpisie](/pl/blog/typescript-basic-types/) przedstawiłem przesłanki stojące za używaniem TypeScripta. Krótko go opisałem i wymieniłem podstawowe typy, przydatne podczas codziennej pracy z oprogramowaniem. Podstawowe jednak typy to za mało, żeby budować współczesne, złożone aplikacje webowe.
