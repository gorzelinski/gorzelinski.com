...
tags: ["oop", "paradygmat", "programowanie", "typescript", "javascript"]
type: "post"
---
...
```typescript #Skrót do definiowania właściwości
class Computer {
...
```typescript #Klasy i dziedziczenie
class Computer {
...
```typescript #Interfejsy i funkcje
...
```javascript #Interfejsy po kompilacji
