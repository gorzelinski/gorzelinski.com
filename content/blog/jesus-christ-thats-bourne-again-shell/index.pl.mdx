...
- `cat` - niestety, komenda ta nie ma nic wspólnego z kotami. Jest to skrót od „konomkatenacji”, oznaczającej łączenie razem. Komenda ta umożliwia przekazywanie lub konkatenację tekstu do ekranu (lub innego programu, pamiętasz potoki?).
