...
Those strange symbols in file names are called **glob patterns.** You can use them for filename matching in shells. They can search for and match characters or substrings.
