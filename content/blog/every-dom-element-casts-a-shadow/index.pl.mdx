...
Shadow DOM jest drugim filarem komponentów internetowych. Aby zobaczyć pierwszy, sprawdź mój poprzedni post — [Web components — czym są custom elements?](/pl/blog/intro-to-web-components-what-are-custom-elements/)
