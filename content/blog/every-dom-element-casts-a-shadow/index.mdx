...
I don't like making cliffhangers like in corny docusoaps, so I described the declarative approach in more detail in [the next post](/blog/from-template-to-shadow-dom-declaratively/). Here, I'll expand on the original method.
...
In this post, we learned about shadow DOM—the second of three pillars of web components. Now you should know what the shadow DOM is, how to use it, and how it interacts with existing web technologies. [The next post](/blog/from-template-to-shadow-dom-declaratively/) will focus on the new declarative syntax for shadow DOM and will wrap up our mini-series. If you're eager to learn more about shadow DOM, check the resources below.
