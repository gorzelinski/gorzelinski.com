...
Ok. . .I never (hehe) said I'll cover all types in one blog post. I'll end here. TypeScript offers even more primitive and advanced types helping you produce more predictable and maintainable code. I'll cover more advanced concepts like [generics](/blog/typescript-generics/), [interfaces](/blog/object-oriented-programming-in-typescript/), or decorators in the future. In the meantime, you can check the following links.
