...
image:
  ...
  caption: 'Zdjęcie autorstwa Pankaj Patel na Unsplash'
...
Na początek, zaimportujmy moduły, których użyjemy. Wykorzystam składnię `require()` dla dynamicznych importów. Jednakże możesz także użyć standardowych modułów ES — w tym celu musisz dodać pole `"type": "module"` do pliku package.json.
