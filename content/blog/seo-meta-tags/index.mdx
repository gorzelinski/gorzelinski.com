...
tags: ['meta tags', 'seo', 'open graph', 'twitter', 'social media', 'html']
type: 'post'
---

If you're looking at this website now, there is a high probability you found it on Google. It is indexed high enough for you to notice it, and information snippets displayed in the SERP (Search Engine Results Page) persuaded you to click on it.

I don't care that much about SEO. I don't use fancy SEO techniques, and—in my opinion—good content is the best SEO strategy. Still, I think there are some meta tags and good practices we can use to make our website rank higher and display better around the web.
...
Meta tags are snippets of text that provide additional information about a website. Search engines use that information to understand page content better. Most meta tags won't be helpful for humans. The name of one meta tag is robots, its target audience. Meta tags are added to the head section of your HTML and won't appear on the page. They can look like this:
...
We can't throw random things in our “heads.” There are specific tags responsible for different things. I'll cover some of them: essential, important for SEO, social, and others. That won't be a definitive list, but for most websites it will be enough.

### Meta charset

This attribute declares the document's character encoding. UTF-8 is the only valid encoding for HTML5 documents, so there is no choice here. There is another restriction—the meta tag with this attribute must be located within the first 1 KB of the document.
...
It's one of the few meta tags that you can see. If you found this blog post on Google, you saw the title of this blog post in your search results. Now it's displayed on your browser tab. Browser tabs and, as mentioned earlier, SERPs display the text from this tag.
...
- A title should persuade readers to click on your website, so it's a good place for novelty, paradox, or humor. But don't use clickbait—don't go to the dark side of the force.
...
Twitter username of the website. It should be preceded by the “@” sign.
...
Combining all that information, here is how one of my last posts renders in the summary card with a large image (yup, I used this example because of the cute Dachshund).
...
It works similarly to the `twitter:description`—a description of the page.
...
SEO is a complex topic, and it's impossible to compress all the helpful information inside one blog post. But some good practices and meta tags are a good start. Additionally, I was planning to write about sitemaps, JSON-LD, language meta tags, etc. But the post is getting long, and those topics are slightly different. I may write about them—you can let me know if you'd like to read more about SEO on my blog. And if you want to read more about SEO now, take a look at the links below.
