...
```javascript #Funkcja konstruktora
...
```javascript #Klasy i dziedziczenie
class Computer {
  constructor(name) {
    this.name = name
  }
...
```javascript #Klasy i polimorfizm
class Computer {
  constructor(name) {
    this.name = name
  }
