...
description: 'Zamiast wskakiwać na hype train ChatGPT, nauczmy się najpierw podstaw AI.'
date: 2023-08-15T10:00:00+02:00
updated: 2023-08-15T10:00:00+02:00
image:
  alt: 'Render 3D ludzkiego mózgu na gradientowym tle'
  caption: 'Zdjęcie autorstwa Milad Fakurian na Unsplash'
...
AI — modne słowo, które otrzymuje coraz więcej atencji. Szczególnie w ostatnich kilku miesiącach. Jeżeli choć w małym stopniu interesujesz się branżą technologiczną, najprawdopodobniej obił ci się o uszy termin „ChatGPT". Według Google Trends zainteresowanie AI wzrosło trzykrotnie w 2023 roku. Słowo kluczowe „chatgpt" uzyskało ogromny przyrost popularności w ciągu ostatnich 12 miesięcy — około 4000% (największy w ogóle)! Jednak nie wsiadam na ten hype train. Nie chcę uczyć się o ChatGPT nie znając podstaw AI. Preferuję wolne i metodyczne podejście — naukę fundamentów i gromadzenie kolejnych warstw wiedzy. Zatem wsiadam chyba na… drezynę? AI łączy wiele interesujących mnie tematów: matematykę, statystykę, informatykę, dane czy nawet filozofię. Ten post pobieżnie dotknie wielu podstawowych definicji i pojęć związanych z AI. Być może będzie to początek długiej wyprawy. Wskakuj — drezyna potrzebuje dwóch ludzi do pompowania. Wszystko, co musimy zrobić, to podążać za tym cholernym pociągiem!
...
Liczba tranzystorów nie dałaby zbyt wiele bez masy danych. AI zaraz po utworzeniu nic nie wie — podobnie do dziecka. Jednocześnie podobnie do dziecka, ma potencjał, żeby uczyć się rzeczy. Zaraz po urodzeniu, dziecko doświadcza wielu różnorodnych bodźców: dźwięków, obrazów, zapachów itp. Z czasem i doświadczeniem, dziecko uczy się na przykład, że wkładanie sobie klocka Lego do nosa nie jest dobrym pomysłem. Z kolejnymi doświadczeniami, dzieciak ma więcej okazji, żeby nauczyć się czegoś.

AI również się uczy, ale wykorzystując dane. Im więcej przykładów ma, tym większe szanse, że znajdzie zależności pomiędzy nimi. AI może wykorzystać te wzorce do predykcji różnych rzeczy. Czym są jednak te przykłady? Dane to nieprzetworzone fakty o, hmm, wszystkim. Może to być arkusz kalkulacyjny z danymi kardiologicznymi, zbiór zdjęć albo nagrania audio.

Im liczniejszy zbiór danych, tym lepiej. Nie powinniśmy jednak poświęcać jakości danych na rzecz ich ilości. Jakość danych jest równie istotna co ich wielkość.
...
Jeżeli chcesz głębszego zrozumienia (jestem mistrzem gładkich przejść) poszczególnych pojęć lub potrzebujesz więcej kontekstu, sprawdź poniższe linki.
