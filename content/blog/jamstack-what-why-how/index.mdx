...
Simple architecture has one more benefit - improved security. Less number of elements means fewer weak links. You don't have to worry about server or database breaches. Hackers have a smaller [attack surface](https://en.wikipedia.org/wiki/Attack_surface) to penetrate.
...
Before making a website with this architecture, consider its pros and cons. This approach is not ideal for every application. If you've decided and want such a fast website or have questions - [write to me](/blog/jamstack-what-why-how/#contact).
