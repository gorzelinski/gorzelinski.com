...
image:
  ...
  caption: 'Photo by Harald Müller on Unsplash'
  src: 'harald-muller-ACAJGonG8rA-unsplash.jpg'
categories: ['web development']
tags:
  ['devops', 'github', 'actions', 'ci', 'cd', 'automation', 'workflow', 'yaml']
type: 'post'
---
...
- You don't need to start from scratch. The mentioned marketplace offers tons of ready-to-use apps and actions. You can also base your custom actions on templates.
...
<Details summary="Show the full CI config">
...
The last two jobs are very similar—they both run end-to-end tests. One runs them on Chrome and one on Firefox. Those jobs must run after the build process. They try to access cached files for the project and Cypress to be efficient. After all the jobs execute successfully, the whole workflow is finished.

![GitHub Actions page with CI schema](../../portfolio/gorzelinski/ci.png)

I hope this post introduced you to GitHub Actions. After reading it, you should know why and how to use them. Maybe you'll even manage to automate some mundane tasks in under 6 hours now. We may continue this automation journey and write a custom GitHub Action. But, for now, the best I can do is to offer you some helpful links.
