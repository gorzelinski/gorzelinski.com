...
O panie, jaki długi plik! Nie bądź przytłoczony jednak — spróbujemy go rozszyfrować. Nasz workflow nazywa się „CI”. Wystartuje, gdy ktoś zrobi PR do gałęzi `main`. Dodatkowo zmiany muszą obejmować pliki z wymienionymi rozszerzeniami. Dlaczego? Bo zmiany w plikach takich jak Markdown lub MDX najprawdopodobniej niczego nie zepsują, więc nie musimy uruchamiać naszego worfklow.
