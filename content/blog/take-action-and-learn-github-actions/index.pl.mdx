...
description: 'Programiści uwielbiają automatyzować rzeczy. Jednak automatyzacja jest korzystna tylko wtedy, gdy zabiera mniej czasu, niż zwraca. Dzięki GitHub Actions może osiągniemy ten zysk.'
date: 2023-06-14T19:00:00+02:00
updated: 2023-06-14T19:00:00+02:00
image:
  alt: 'Zużyty, czarno-biały klaps filmowy'
  caption: 'Zdjęcie autorstwa Harald Müller na Unsplash'
...
Na początek zapoznajmy się z podstawową terminologią. Będziemy się uczyć z góry na dół, zaczynając od ogólnych pojęć i przechodząc do detali.
...
<Details summary="Pokaż pełną konfigurację CI">
...
O panie, jaki długi plik! Nie bądź jednak przytłoczony — spróbujemy go rozszyfrować. Nasz workflow nazywa się „CI”. Wystartuje, gdy ktoś zrobi PR do gałęzi `main`. Dodatkowo zmiany muszą obejmować pliki z wymienionymi rozszerzeniami. Dlaczego? Bo zmiany w plikach takich jak Markdown lub MDX najprawdopodobniej niczego nie zepsują, więc nie musimy uruchamiać naszego workflow.
...
Mam nadzieję, że ten post był niezłym wprowadzeniem do GitHub Actions. Po jego przeczytaniu powinieneś wiedzieć, dlaczego i jak ich używać. Być może będziesz nawet w stanie zautomatyzować jakieś żmudne zadania w mniej niż 6 godzin. Być może będziemy kontynuowali naszą zautomatyzowaną przygodę i napiszemy jakąś niestandardową akcję GitHub. Jednak na razie, the best I can do to zaoferować przydatne linki.
