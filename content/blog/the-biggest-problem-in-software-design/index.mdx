...
image:
  ...
  caption: 'Photo by Kier in Sight Archives on Unsplash'
...
Complexity is more apparent to readers than to code writers—similar to [standard writing](/blog/the-craft-of-writing). If the code seems simple to you but not to the reader, then it probably is complex.
...
2. It makes it easier to evolve the system.
...
2. Never use the common name for anything besides the given purpose.
...
Readers should determine readability, not the code writer—similarly to [writing English](/blog/the-craft-of-writing). If you write code with short variable names and the people who read it find it easy to understand, that's fine.
