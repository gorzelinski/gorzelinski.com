...
Projektowanie zacząłem od przygotowania kilku, zgrubnych szkiców sekcji i podstrony realizacje. Następnie szybko przeszedłem do eksperymentowania z róznymi fontami i kolorami.

![Zestawienie różnych fontów i kolorów](./fonts-and-colors.png "Fragment moich eksperymentów z fontami i kolorami")

Na podstawie szkiców i eksperymentów przygotowałem kilka próbnych układów, które podesłałem właścicielowi. Jego decyzje wpłynęły na dalsze prace.

![Pierwszy testowy układ strony głównej](./landing-wireframe-1.png "Testowy układ strony głównej")

![Drugi testowy układ strony głównej](./landing-wireframe-2.png "Inny testowy układ strony głównej")
