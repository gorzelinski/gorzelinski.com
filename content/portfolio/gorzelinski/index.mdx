...
description: "After several months of designing, coding, and writing, I've finally published my website."
...
Wireframes should be like a middle ground between sketches and higher fidelity designs and prototypes. Not worrying too much about fonts and colors, I've made a lot of wireframes.
...
I found that flexibility is desirable during the whole process. Same as breaks - it gives a new perspective. New ideas were coming to me at the different stages of the process and in unexpected moments. Like the idea for the progress bar - I found it surfing the web. Yes, I stole it, and I'm not ashamed of that!
...
But, if pages are prebuilt, how to know which theme the user chose? Implementing the theme switching feature was an unexpected challenge for me. But, after some reading on Gatsby's build process and testing, I managed to make it work smoothly.

<img
  style="max-width: 100%; border: 1px var(--color-gray-80) solid;"
  alt="Switching themes on my website"
